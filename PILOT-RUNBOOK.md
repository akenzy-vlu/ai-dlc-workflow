...
| -------------------------- | ----------------------- | -------------------------------- |
| The UTSer Flutter monorepo | `profile-utser-flutter` | the profile's `discover_repo.py` |
...
(`ai-dlc-core/references/profile-contract.md`).
...
cp -r "$AIDLC_SRC/examples/profile-utser-flutter" .claude/skills/profile-utser-flutter   # UTSer only
```
...
# UTSer Flutter — richer: enumerates utse_ui_kit widgets and segmentOf() route keys.
# The profile is project-scoped, so its path is inside the repo, not under ~/.claude/skills/
python3 .claude/skills/profile-utser-flutter/scripts/discover_repo.py . -o .ai/architecture.md
```
...
The first version of this runbook hardcoded the UTSer Flutter profile into every command,
...
| Need                                         | Read                                                         |
| -------------------------------------------- | ------------------------------------------------------------ |
| Why each gate exists                         | `ai-dlc-core/references/methodology.md`                      |
| Artifact templates and frontmatter schemas   | `ai-dlc-core/references/templates.md`                        |
| What to ask a human vs look up               | `ai-dlc-core/references/discovery-protocol.md`               |
| Sync options, `.gitignore`, CI               | `ai-dlc-core/references/sync.md`                             |
| Flutter conventions and DoD (example only)   | `examples/profile-utser-flutter/references/flutter-rules.md` |
| Adding a second stack, and where it installs | `ai-dlc-core/references/profile-contract.md`                 |

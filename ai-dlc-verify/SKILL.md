...
A verification tool installed globally will meet projects that have no login, no staging
environment, or no credentials on this machine. It must be uneventful in all three cases.
